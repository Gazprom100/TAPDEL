...
export const GAME_MECHANICS = {
  ...
  ENERGY: {
    CONSUMPTION_RATE: {
      'N': 0,       // Нейтраль не расходует топливо
      '1': 0.006,   // 0.006% за тап - при 20 тапах/сек = 0.12%/сек = 100% за 833сек (13.9мин)
      '2': 0.009,   // 0.009% за тап - при 20 тапах/сек = 0.18%/сек = 100% за 556сек (9.3мин)
      '3': 0.012,   // 0.012% за тап - при 20 тапах/сек = 0.24%/сек = 100% за 417сек (6.9мин)
      '4': 0.015,   // 0.015% за тап - при 20 тапах/сек = 0.30%/сек = 100% за 333сек (5.6мин)
      'M': 0.0165   // 0.0165% за тап - при 20 тапах/сек = 0.33%/сек = 100% за 300сек (5мин) - МАКСИМУМ
    },
    MIN_LEVEL: 0,
    MAX_LEVEL: 100,
    RECOVERY_RATE: 0.033, // 0.033% за 100мс = 0.33%/сек = 100% за 300сек (5 минут)
    RECOVERY_INTERVAL: 100, // мс
