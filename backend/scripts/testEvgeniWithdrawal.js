...
async function testEvgeniWithdrawal() {
  console.log('🎯 ТЕСТ ВЫВОДА ДЛЯ EVGENI_KRASNOV');
  console.log('====================================');
  
  const userId = 'telegram-297810833'; // Evgeni_Krasnov
  const amount = 2222; // 2222 DEL
  ...
  try {
    ...
    console.log('✅ Вывод 2222 DEL от Evgeni_Krasnov создан');
...
if (require.main === module) {
  testEvgeniWithdrawal()
    .then(success => {
      if (success) {
        console.log('\n🎉 ТЕСТ ВЫВОДА ПРОШЕЛ УСПЕШНО!');
        console.log('✅ 2222 DEL отправлены на адрес 0xd6187dD54DF3002D5C82043b81EdE74187A5A647');
        process.exit(0);
      } else {
...
module.exports = { testEvgeniWithdrawal }; 